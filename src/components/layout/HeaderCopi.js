                                    ...
                                    <div className="dropdown dropdown-user">
                                        <button className="dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                            <span className="letter-name">
                                                {this.state.dataUSer.nombre.charAt(0)}{this.state.dataUSer.apellido.charAt(0)}
                                            </span>
                                            {this.state.dataUSer.nombre}<br/>{this.state.dataUSer.apellido}
                                        </button>
                                        <div className="dropdown-menu">
                                            {this.state.dataUSer.id_proveedor === null &&
                                                <button  type="button" onClick={this.handleOnCloseSecion} className="dropdown-item">Salir 1</button>
                                            }
                                            {this.state.dataUSer.id_proveedor !== null &&
                                                <button  type="button" onClick={this.handleOnCloseSecionProveedor} className="dropdown-item">Salir 2</button> 
                                            }     
                                        </div>
                                    </div>
                                </div>
