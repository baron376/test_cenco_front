    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                {hasPermission([210]) ?
                  <div>
                    <h2 className="mt-4 mb-4">Secciones</h2>
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        {hasPermission([109]) &&
                            <button onClick={propsInt.newOrEditSesiones.bind(this, 0)} type="button" data-toggle="modal" data-target="#modal-lg" className="btn btn-primary">Crear Sección</button>
                        }
                            <SesionesNew
