...
import CadenaNew from './CadenaNew';
import CadenaShow from './CadenaShow';
...
export default class Cadena extends Component {º
    render() {
        ...
        return (
            ...
            {hasPermission([113]) ?
                  <div>
                <h2 className="d-flex justify-content-between mt-4 mb-4">Cadenas
                    {hasPermission([100]) &&
                        <button onClick={propsInt.newOrEditCAdena.bind(this, 0)} type="button" data-toggle="modal" data-target="#modal-lg" className="btn btn-primary">Crear Cadena</button>
                    }
                        <CadenaNew
