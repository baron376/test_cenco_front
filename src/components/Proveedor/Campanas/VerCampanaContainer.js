...
export default class VerCampanaContainer extends Component {
    state = {
        ...
        errorsMaterial: {
            ...
            medida_materia:'', 
            fileHead:'',
            file :'La imagen del material es obligatorio!'
    ...
    Materiales_change = async function (){
        ...
        console.log('esto es el array de materialesssssss' , this.state.carrucelImage64)
        ...
        console.log('asda de  imagen',arrayLocalImage);
    ...
    handleSubmitBs = async e =>{
      ...
      if(this.validateForm(this.state.errorsExterno)) {
        ...
        swal({
            ...
            text: "La campaña podrá ser usada en el sistema!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
