                ...
                <div className="dropdown">
                    ...
                    <div className="dropdown-menu">
                        {hasPermission([505,515,306]) &&
                            <Link to={`/VerPropuestaNew-${row.id}`}> <button title="Ver Campaña" className="dropdown-item" data-toggle="modal" data-target="#modal-lg-sh"><FontAwesomeIcon icon={faEye}/> Ver Campaña</button></Link>
                        }
                        {hasPermission([505]) &&
                        ...
                        {row.id_etapa === 3 && hasPermission([519,306]) &&
