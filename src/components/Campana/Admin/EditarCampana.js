                ...
                <div className="col-10 tabs cont-height">
                    ...
                    <form  onSubmit={propsInt.handleSubmitBs}>
                        <div className="modal-body">
                            ...
                            <div className="form-group">
                                <label htmlFor className="col-sm-2 col-form-label">Nombres:</label>
                                <div className="col-sm-6">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-sm-6">
                                    <DatePicker 
                                        // minDate={dataAll.minDateValue} 
                                        className="input-datapiker" 
                                        dateFormat="dd/MM/yyyy" 
                                        // dateFormat="yyyy-MM-dd" 

                                        selected={dataAll.dateFrom} 
                                        onChange={(date) => {

                                        propsInt.setDateFrom(date)
                                    }}
                                    > </DatePicker>
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-sm-3">
                                    ...
                                    selected={dataAll.dateTo} 
                                    onChange={(date) => {
                                        propsInt.setDateTo(date)
                                    }} 
                                    > </DatePicker>
                                    &emsp;<FontAwesomeIcon icon={faCalendar} />
                                </div>
