            ...
            <React.Fragment>
                ...
                {hasPermission([306]) ?
                  <div >
                    ...
                    <h2 className="mt-4 mb-4 d-flex justify-content-between">
                      Campañas Proveedor 
                      {hasPermission([300]) &&
                        <Link to='/CrearCampana'> <button  type="button" data-toggle="modal" data-target="#modal-lg" className="btn btn-primary">Crear Campañas</button> </Link>
                      }
                    </h2>
