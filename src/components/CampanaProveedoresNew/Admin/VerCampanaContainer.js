        ...
        this.setState(
            {
              ...
              // descripcion_estado: this.state.campanaDetailsData.campana_estado.descripcion,
               stado_descripcion_estado: this.state.campanaDetailsData.campana_estado.nombre+' - ('+this.state.campanaDetailsData.campana_estado.descripcion+')',
               ...
               //elementos: this.state.campanaDetailsData.elementos.name,
            })
